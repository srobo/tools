...
# -*- coding: utf-8 -*-
#
# Student Robotics Tools documentation build configuration file, created by
...
latex_documents = [
  ('index', 'StudentRoboticsTools.tex', 'Student Robotics Tools Documentation',
   'Student Robotics', 'manual'),
]
