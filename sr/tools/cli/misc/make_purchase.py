...
def command(args):
    ...
    for purchase in spend_request.purchases:
        ...
        print(i.format(date=today.isoformat(),
                       summary=purchase.summary,
                       account=srspending.budget_line_to_account(purchase.budget_line),
...
def add_subparser(subparsers):
    parser = subparsers.add_parser('make_purchase', help="Make an SR purchase request")
    ...
    parser.add_argument("--dry-run", action="store_true",
                        help="Process and check everything, but don't actually create purchasing ticket" )
