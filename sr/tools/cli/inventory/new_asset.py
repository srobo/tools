...
def add_subparser(subparsers):
    ...
    parser.add_argument("-e", "--editor", action="store_true", default=False, dest="start_editor", help="Open up the newly created asset file in $EDITOR")
    parser.add_argument("assetname", metavar="ASSET", help="The name of an asset template file in /.meta/parts.")
