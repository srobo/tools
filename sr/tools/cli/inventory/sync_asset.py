...
def add_subparser(subparsers):
    parser = subparsers.add_parser('inv-sync-asset',
                                   help="Replace the contents of an asset file with the contents of its corresponding template. WARNING: This command will completely overwrite an asset file, this includes the 'labelled' field.")
